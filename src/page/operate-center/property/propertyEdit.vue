...
<script type="text/ecmascript-6">
  ...
  export default {
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            if (formShow === 'basis') {
              ...
              // 编辑房源基础信息
              const Editroom = new Promise((resolve, reject) => {
                this.$http({
                  method: 'post',
                  url: window.config.server + '/api/v1/rooms/' + this.$route.params.propertyId + '/room',
                  data: {
            ...
            if (formShow === 'supporting') {
              ...
              const Editroom = new Promise((resolve, reject) => {
                this.$http({
                  method: 'post',
                  url: window.config.server + '/api/v1/rooms/' + this.$route.params.propertyId + '/bedSetting',
                  data: {
            ...
            if (formShow === 'service') {
              ...
              // 编辑房源设施信息
              const EditRoomFacilitiesAndOtherServices = new Promise((resolve, reject) => {
                this.$http({
                  method: 'post',
                  url: window.config.server + '/api/v1/rooms/' + this.$route.params.propertyId + '/roomFacilitiesAndOtherServices',
                  data: {
              ...
              EditRoomFacilitiesAndOtherServices.then((resolve) => {
                if (resolve.data.code === '200') {
                  this.propertyId = resolve.data.roomId
    ...
    created: function () {
      ...
      // 获取基础设备
      const Infrastructure = new Promise((resolve, reject) => {
        this.$http({
          method: 'get',
      ...
      // 获取生活设施
      const LivingFacilities = new Promise((resolve, reject) => {
        this.$http({
          method: 'get',
          url: window.config.server + '/api/v1/base/facilities',
          params: {
      ...
      // 获取洗浴设施
      const Toiletries = new Promise((resolve, reject) => {
        this.$http({
          method: 'get',
          url: window.config.server + '/api/v1/base/facilities',
          params: {
      ...
      // 获取娱乐设施
      const EntertainmentFacilities = new Promise((resolve, reject) => {
        this.$http({
          method: 'get',
          url: window.config.server + '/api/v1/base/facilities',
          params: {
      ...
      // 获取安全设施
      const SafetyFacilities = new Promise((resolve, reject) => {
        this.$http({
          method: 'get',
          url: window.config.server + '/api/v1/base/facilities',
          params: {
      ...
      Info.then((resolve) => {
        ...
        resolve.data.facilities.forEach((data) => {
          if (data.type === 0) infrastructure.push(data.name)
          if (data.type === 1) livingFacilities.push(data.name)
          if (data.type === 2) toiletries.push(data.name)
          if (data.type === 3) entertainmentFacilities.push(data.name)
          if (data.type === 4) safetyFacilities.push(data.name)
          if (data.type === 5) surroundingFacilities.push(data.name)
        })
        let services = [] // 服务
